...
def get_price_history(ticker: str, days: int = 60) -> pd.DataFrame | None:
    """
    Descarga historial OHLCV usando yfinance y calcula SMA20/SMA50.
    Retorna DataFrame con columnas: Open, High, Low, Close, Volume, SMA20, SMA50.
    """
    try:
